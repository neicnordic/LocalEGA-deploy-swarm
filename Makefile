...
#Interceptor CEGA details
export CEGA_MQ_CONNECTION=<to-be-filled>

# Proxy service CEGA details
export BROKER_HOST=rabbitmq-test.ega-archive.org
export BROKER_PORT=5673
export BROKER_USERNAME=<to-be-filled>
export BROKER_PASSWORD=<to-be-filled>
export BROKER_VHOST=<to-be-filled>
...
export CEGA_USERNAME=<to-be-filled>
export CEGA_PASSWORD=<to-be-filled>

# Test user in Norway1
export EGA_BOX_USERNAME=<to-be-filled>
export EGA_BOX_PASSWORD=<to-be-filled>
